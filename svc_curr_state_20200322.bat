@echo Restore Service Startup State saved at 3/22/2020 1:31:48 AM
...
sc.exe config AarSvc_1728f65 start= demand
sc.exe config BcastDVRUserService_1728f65 start= demand
sc.exe config BluetoothUserService_1728f65 start= demand
sc.exe config CaptureService_1728f65 start= demand
sc.exe config cbdhsvc_1728f65 start= demand
sc.exe config CDPUserSvc_1728f65 start= auto
sc.exe config ConsentUxUserSvc_1728f65 start= demand
sc.exe config CredentialEnrollmentManagerUserSvc_1728f65 start= demand
sc.exe config DeviceAssociationBrokerSvc_1728f65 start= demand
sc.exe config DevicePickerUserSvc_1728f65 start= demand
sc.exe config DevicesFlowUserSvc_1728f65 start= demand
sc.exe config MessagingService_1728f65 start= demand
sc.exe config OneSyncSvc_1728f65 start= delayed-auto
sc.exe config PimIndexMaintenanceSvc_1728f65 start= demand
sc.exe config PrintWorkflowUserSvc_1728f65 start= demand
sc.exe config UnistoreSvc_1728f65 start= demand
sc.exe config UserDataSvc_1728f65 start= demand
sc.exe config WpnUserService_1728f65 start= auto
@pause
