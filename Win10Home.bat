@echo Restore Service Startup State saved at 3/22/2020 3:53:04 PM
...
sc.exe config DeviceInstall start= auto
...
sc.exe config DisplayEnhancementService start= auto
...
sc.exe config KeyIso start= disabled
...
sc.exe config AarSvc_2f710 start= demand
sc.exe config BcastDVRUserService_2f710 start= demand
sc.exe config BluetoothUserService_2f710 start= demand
sc.exe config CaptureService_2f710 start= demand
sc.exe config cbdhsvc_2f710 start= demand
sc.exe config CDPUserSvc_2f710 start= auto
sc.exe config ConsentUxUserSvc_2f710 start= demand
sc.exe config CredentialEnrollmentManagerUserSvc_2f710 start= demand
sc.exe config DeviceAssociationBrokerSvc_2f710 start= demand
sc.exe config DevicePickerUserSvc_2f710 start= demand
sc.exe config DevicesFlowUserSvc_2f710 start= demand
sc.exe config MessagingService_2f710 start= demand
sc.exe config OneSyncSvc_2f710 start= disabled
sc.exe config PimIndexMaintenanceSvc_2f710 start= demand
sc.exe config PrintWorkflowUserSvc_2f710 start= demand
sc.exe config UnistoreSvc_2f710 start= demand
sc.exe config UserDataSvc_2f710 start= demand
sc.exe config WpnUserService_2f710 start= auto
