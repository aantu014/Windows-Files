@echo Restore Service Startup State saved at 4/7/2020 9:10:46 PM

sc.exe config AJRouter start= disabled
sc.exe config ALG start= disabled
sc.exe config AppReadiness start= disabled
sc.exe config AudioEndpointBuilder start= disabled
...
sc.exe config DeviceInstall start= disabled
...
sc.exe config DisplayEnhancementService start= disabled
...
sc.exe config MSSQLFDLauncher start= disabled
...
sc.exe config OpenVPNService start= disabled
sc.exe config OpenVPNServiceInteractive start= disabled
sc.exe config OpenVPNServiceLegacy start= disabled
...
sc.exe config Power start= disabled
...
sc.exe config ReportServer start= disabled
...
sc.exe config tvnserver start= disabled
...
sc.exe config wampmariadb start= disabled
...
sc.exe config OneSyncSvc_ffd9 start= disabled
@pause
